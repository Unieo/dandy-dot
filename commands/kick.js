...
module.exports = {
	...
	run(client, message, args){
		...
		if (user == config.botid) return message.channel.send("**Error:** You cannot kick me!")
		if (user == message.author.id) return message.channel.send("**Error:** You cannot kick yourself!")
		if(user){
