...
module.exports = {
	...
	run(client, message, args){
		...
		if (user == config.botid) return message.channel.send("**Error:** You cannot ban me!")
		if (user == message.author.id) return message.channel.send("**Error:** You cannot ban yourself!")
		if(user){
